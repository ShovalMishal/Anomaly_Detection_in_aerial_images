...
prepare_data_pyramid_cfg = dict(skip_stage=True, use_gsd=True, normalize_sizes=[0.25, 0.5, 1, 1.5, 3, 5],
                                config_template="/home/adminubuntu/Documents/Repositories/Anomaly_Detection_in_aerial_images/configs/experiment_6_multiscale/imgsplit_config.json")
